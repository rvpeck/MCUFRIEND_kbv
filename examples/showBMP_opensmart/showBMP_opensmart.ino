...
//
// OPENSMART Shields route SD to 3x2 SPI header.
// So they will work with <SD.h>
//
...
#if defined(ESP32)
#define SD_CS     5
#elif defined(OPENSMART_KBV_H_)
#define SD_CS     5
#else
#define SD_CS     10        //regular Mcufriend Shields
#endif

#if defined(OPENSMART_KBV_H_) && defined(__AVR_ATmega328P__)
#define RESTORE_SPI_GPIO()   { SPCR = 0; } //shared pins on Uno
#else
...
//OpenSmart on Mega can support PALATTEDEPTH=8.  Uno can do =4
...
uint8_t showBMP(char *nm, int x, int y)
{
    ...
    if (bmpID != 0x4D42) ret = 2; // bad ID
        ...
        // enable next line to match image shape
